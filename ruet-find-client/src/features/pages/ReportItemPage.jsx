...
const CATEGORIES = [
  ...
  { label: 'Bag & Wallet', value: 'bags' },
  { label: 'ID & Cards', value: 'documents' },
  { label: 'Keys', value: 'keys' },
  { label: 'Clothing', value: 'clothing' },
  { label: 'Books & Stationery', value: 'books' },
  { label: 'Jewelry & Accessories', value: 'other' },
...
export default function ReportItemPage() {
  ...
  const handleSubmit = async () => {
    ...
    fd.append('dateLostFound', formData.dateLostFound);
          ...
          {step === 4 && (
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-4">
                <ReviewRow label="Item Name" value={formData.title || '—'} />
                ...
                <ReviewRow label="Date" value={formData.dateLostFound || '—'} />
